...
from QuadLoco.tasks.manager_based.quadloco.robotlab_env_cfg import LocomotionVelocityRoughEnvCfg
...
# use local assets
from QuadLoco.assets.unitree import UNITREE_A1_CFG  # isort: skip
